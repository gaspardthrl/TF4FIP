...
import logging
import os
from uni2ts.model.moirai import MoiraiMoEForecast, MoiraiMoEModule
...
def main(args):
    try:
        ...
        model = MoiraiMoEForecast(
            module=MoiraiMoEModule.from_pretrained(f"Salesforce/moirai-moe-{args.model_version}-{args.model_size}"),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_version", type=str, default="1.0-R", help="Model version to be used (e.g., 1.0-R).")
